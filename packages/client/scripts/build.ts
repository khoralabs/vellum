...
const bundledTypePackages = [
  ...
  {
    dir: path.join(repoRoot, "vendor/relay/packages/relay-client"),
    name: "@khoralabs/relay-client",
  },
  {
    dir: path.join(repoRoot, "vendor/relay/packages/relay-crypto"),
    name: "@khoralabs/relay-crypto",
  },
  { dir: path.join(repoRoot, "vendor/relay/packages/relay-mls"), name: "@khoralabs/relay-mls" },
  { dir: path.join(repoRoot, "vendor/obp/packages/model/impl/ts"), name: "@khoralabs/obp-model" },
  {
    dir: path.join(repoRoot, "vendor/obp/packages/bind-policy"),
    name: "@khoralabs/nbc-bind-policy",
  },
  {
    dir: path.join(repoRoot, "vendor/obp/packages/frames/impl/ts"),
    name: "@khoralabs/obp-frames-impl",
  },
  { dir: path.join(repoRoot, "vendor/obp/packages/nbc/impl/ts"), name: "@khoralabs/obp-nbc" },
] as const;
